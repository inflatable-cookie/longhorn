...
const MAXIMUM_FORK_ID_BYTES: usize = 128;
...
fork_id!(
    ForkBranchId,
    "Injected stable identity for one private prototype branch reference."
);
fork_id!(
    ForkCheckpointId,
    "Opaque identity for one consumer-owned private prototype checkpoint."
);
...
/// Invalid private prototype identity.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ForkIdentityError {
    /// Empty identity.
    Empty,
    /// Identity exceeded the hard byte limit.
    TooLong {
