...
use crate::{
    ApplyPlan, AttachGeneration, NativeContentFailureCode, NativeContentIslandId,
    NativeContentOperation, NativeContentRevision, PlanStepId, ReceiptError,
};
...
impl ApplyReceipt {
    /// Reconciles sparse adapter execution reports with every planned operation.
    pub fn build(
        plan: &ApplyPlan,
