use longhorn_core::{ClientRect, PhysicalRect, PhysicalSize, RoundingMode, ScaleFactor, WindowId};
use serde::{Deserialize, Serialize};

use crate::{
    AttachGeneration, NativeContentIslandId, NativeContentKindId, NativeContentRevision,
    VisibilityReasonId,
};
...
impl DesiredState {
    /// Constructs initial desired state from immutable identity and full input.
    #[must_use]
    pub fn new(
        island_id: NativeContentIslandId,
        kind_id: NativeContentKindId,
