...
import { assert, repoRoot } from "./private-candidate-card149/support";

const receipt = JSON.parse(await readFile(join(repoRoot, "fixtures/release/card149/private-0-1-candidate-v2.json"), "utf8")) as {
  version: string;
  sources: {
...
console.log(JSON.stringify({
  schema: "longhorn.card149-candidate-doc-proof.v1",
  outcome: "pass",
