...
const policies = {
  "minimal-operation": {
    longhorn: ["@longhorn/core", "@longhorn/operation"],
    imports: ["@longhorn/operation"],
    permissions: [],
    forbidden: [
      "@longhorn/bridge",
      "@longhorn/commands",
  ...
  soundcheck: {
    longhorn: ["@longhorn/core", "@longhorn/operation"],
    imports: ["@longhorn/operation", "@longhorn/operation/tauri"],
    permissions: [
  ...
  loophole: {
    ...
    imports: [
      ...
      "@longhorn/notifications/tauri",
      "@longhorn/operation",
      "@longhorn/operation/bridge",
      "@longhorn/operation/poodle",
      "@longhorn/operation/svelte",
      "@longhorn/operation/tauri",
    ],
    permissions: [
      "allow-longhorn-operation-read",
      "allow-longhorn-operation-manage",
  ...
  "notification-only": {
    longhorn: ["@longhorn/core", "@longhorn/notifications"],
    imports: ["@longhorn/notifications", "@longhorn/notifications/tauri"],
    permissions: [
      "read-notifications",
      "manage-notifications",
      "core:event:allow-listen",
