export type SelectedContracts = {
  ...
  poodle: typeof import("@inflatable-cookie/longhorn-poodle-svelte/poodle");
  ...
  svelte: typeof import("@inflatable-cookie/longhorn-poodle-svelte");
...
export const selectedModules = [
  ...
  "@inflatable-cookie/longhorn-poodle-svelte/poodle",
