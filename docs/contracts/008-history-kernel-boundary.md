...
- `@inflatable-cookie/longhorn-poodle-svelte/history/svelte`: optional per-instance reactive state
- `@inflatable-cookie/longhorn-poodle-svelte/history/poodle`: optional linear panel composition over public
  Poodle primitives
