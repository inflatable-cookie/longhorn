...
| [022 Agent App Control](022-agent-app-control.md) | compile-time opt-in MCP control surface: semantic input, capture, commands, and agent-answerable JS path selection | active; source-linked Figmatic live proof accepted, publication pending |
