...
- [x] restore clean Loophole baseline health
- [x] admit exact private Longhorn and Poodle source and artifact graphs
...
83-variant history boundary, and rollback order.
...
Card 104 removes Pulse's unused `rusqlite 0.31` declaration and resolves one
Soundcheck-owned `rusqlite 0.40.1` graph without schema or data-meaning change.
