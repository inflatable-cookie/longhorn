...
| [g01.015](015-loophole-full-hosting-migration.md) | executing; Card 105 ready | advanced full-stack consumer |
...
Surface-enabled graph for Cards 105-111. Card 105's storage slice is ready;
later systems and package publication remain outside the admitted graph.
