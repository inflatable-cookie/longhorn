...
- Re-opening the authorization model. Per-route checks, strict grammars, and
  epoch discipline held up under audit; this task extends them, it does
  not revise them.

## Next Task

Task complete. Next in the audit suite: g02.023 (credential and
...
- Card 204: complete 2026-08-14 — event scoping decision.
- Card 205: complete 2026-08-14 — session teardown and entropy.
- Card 206: complete 2026-08-14 — example hardening and ACL proof.
