...
**Workflow edits landed 2026-08-15 (approved):** actions SHA-pinned in both
workflows, the floor toolchain is read from the single declaration, and the
publish step installs `npm@11.5.1` rather than `npm@latest`.
...
- [x] CI runs on pinned toolchains and actions — landed 2026-08-15
