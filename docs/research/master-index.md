...
| agent app control | [Agent App Control](translation-memos/024-agent-app-control.md) | `../contracts/022-agent-app-control.md`; `../roadmaps/g02/README.md`; milestones g02.029-032, cards 227-234 |
