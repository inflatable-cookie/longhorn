...
Shared configuration pages live in `@inflatable-cookie/longhorn-poodle-svelte/config/poodle`. Register only
...
`examples/settings-composition-proof/`. The closeout evidence is in the 2026-07-29 delivery log (Git history).
