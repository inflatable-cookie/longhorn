...
Related: `002-production-contextual-agent-tool-boundary.md` (Git history)
...
Swallowtail as reconciled in `002-production-contextual-agent-tool-boundary.md` (Git history).
...
Operator-confirmed 2026-09-07; independently accepted Desktop PR144 merged at
`2a1bad3f`. This promoted only the provider-free L1/D1 composition above.
Production adoption, provider execution, dependency changes and releases
remain held. Contract022 remains byte-for-byte dev-only. L1 neither resolves
credentials nor exposes credential material; credential-reference production
proof is held.
