...
title: "Flatten Northstar tasks and compact historic generations in longhorn"
...
Run the one-time Northstar flattened-task switchover in `longhorn`. Compact
...
- Integration checkout: `/Users/tom/Dev/projects/longhorn` on clean, synchronized `main` at the commit
