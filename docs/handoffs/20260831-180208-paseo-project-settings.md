...
created: 2026-08-31
updated: 2026-08-31
handoff_path: /Users/tom/Dev/projects/longhorn/docs/handoffs/20260831-180208-paseo-project-settings.md
...
useful Paseo settings. This lane owns the longhorn repository only.
...
- **Planning base commit:** `ecd9f89b5771065cc5509310809551031f307196`
- **Pushed main verification:** planning base matched `origin/main` before this
  handoff commit
- **Planning checkout:** dirty with unrelated operator work; do not touch it
...
- Longhorn has a real `bootstrap:deps` task plus `qa` and `qa:docs`. Its primary checkout has unrelated dirty work; preserve it completely and work only in the Paseo worktree.
