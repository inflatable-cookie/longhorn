...
| deferred | donor cutover, production tree packages, branch clients, checkpoint clients, project versions, collaboration, registry publication |

Card 068 proves fork topology privately. Card 069 promotes its semantics into
planned g01.017 while retaining the prototype as research. Linear mode remains
the only public artifact claim until that separate lane passes production
artifact proof.
