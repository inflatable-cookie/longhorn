...
| deferred | donor cutover, tree navigation/retention/persistence/clients/artifacts, project versions, collaboration, registry publication |
...
remains the only compatibility-proved artifact until Card 074.
