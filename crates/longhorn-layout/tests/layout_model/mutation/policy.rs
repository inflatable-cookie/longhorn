use longhorn_layout::{
    LayoutMutationCommand, LayoutMutationEngine, LayoutMutationRejectionCode, LayoutMutationRequest,
};

use crate::support::*;

#[test]
fn singleton_one_per_container_bounded_and_multiple_are_enforced() {
    ...
    let singleton = request(
        ...
        LayoutMutationCommand::CreatePanel {
            ...
            container_id: container_id("container:secondary"),
    ...
    let bounded_same_container = request(
...
fn request(
    id: &str,
    document: &longhorn_layout::LayoutDocument,
