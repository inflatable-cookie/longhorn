...
// structurally -- Poodle does, because it may not depend on Longhorn -- has no
// compile-time link to them, so a field added here is silent on their side.
// Whoever sees both can assert their shape against these and fail when it
// drifts.
