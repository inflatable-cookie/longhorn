...
export const pathPage: ForkPathPageSnapshot = { protocolVersion: 1, authorityEpoch: 7, historyId: "history:tree", revision: 4, branchId: null, headEntryId: "entry:c", rootContinuationCount: 1, offset: 0, totalEntries: 3, entries: [
