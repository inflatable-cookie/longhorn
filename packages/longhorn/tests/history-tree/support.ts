...
export const pathPage: ForkPathPageSnapshot = { protocolVersion: 1, authorityEpoch: 7, historyId: "history:tree", revision: 4, branchId: null, headEntryId: "entry:c", offset: 0, totalEntries: 3, entries: [
  { entryId: "entry:c", label: "Resize region", kindId: "fixture:layout", groupId: null, recordedAt: null, sequence: 3, committedRevision: 3, encodedWeight: 16, position: "future" },
  { entryId: "entry:b", label: "Move panel", kindId: "fixture:layout", groupId: null, recordedAt: 1765432100000, sequence: 2, committedRevision: 2, encodedWeight: 16, position: "current" },
