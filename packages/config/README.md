...
Import `@inflatable-cookie/longhorn-config` for the framework-neutral client. The generated
`@inflatable-cookie/longhorn-config/protocol` declarations remain Rust-owned checked artifacts.
Import `@inflatable-cookie/longhorn-config/poodle` for the optional public-Poodle storage,
